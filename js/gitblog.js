var gitblog = function(config) {
    ...
    var Footer = function() {
        ...
        this.icons = [];
        this.icon_num = 0;
        this.content = 'Powered by <a href="https://github.com/LL-Pengfei/LL-Pengfei.github.io/" target="_blank" style="color: aquamarine;text-decoration:none;border-bottom: 1px solid #79f8d4;">GitHub</a>';
    }
